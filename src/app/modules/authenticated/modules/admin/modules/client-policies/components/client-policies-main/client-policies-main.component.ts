...
import { AdminClientPoliciesService } from '@app/@shared/services/admin/client-policies/client-policies.service';

import * as Fuse from 'fuse.js';

@Component({
  selector: 'admin-client-policies-main',
  templateUrl: './client-policies-main.component.html',
  styleUrls: ['./client-policies-main.component.scss']
})
export class AdminClientPoliciesMainComponent implements OnInit, OnDestroy, AfterViewInit {
  private providersSub: Subscription;
  page_permission = 'clients_policies_mgmt_view';
  ...
  constructor (
    private assPolicyService: AdminClientPoliciesService,
