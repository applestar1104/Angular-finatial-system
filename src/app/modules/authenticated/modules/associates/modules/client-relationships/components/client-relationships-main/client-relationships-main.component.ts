...
@Component({
  selector: 'associates-client-relationships-main',
  templateUrl: './client-relationships-main.component.html',
  styleUrls: ['./client-relationships-main.component.scss']
})
export class AssociatesClientRelationshipsMainComponent implements OnInit, OnDestroy {
  private clientSourceSub: Subscription;
  private clientSub: Subscription;
  private _createdSwalSubscriptions: Subscription;
  private _mergedSwalSubscriptions: Subscription;
  private page_permission = 'associate_clients_view';
  ...
  constructor (
    ...
    this._createdSwalSubscriptions = this.assClientService.createdSwal.subscribe(() => this.getClients());
    this._mergedSwalSubscriptions = this.assClientService.mergedSwal.subscribe(() => this.getClients());
