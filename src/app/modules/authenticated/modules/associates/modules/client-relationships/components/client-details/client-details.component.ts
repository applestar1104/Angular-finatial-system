...
@Component({
  selector: 'associates-client-details',
  templateUrl: './client-details.component.html',
  styleUrls: ['./client-details.component.scss']
})
export class AssociatesClientDetailsComponent implements AfterContentInit, OnInit, OnDestroy {
  private page_permission: string = 'associate_clients_view';
