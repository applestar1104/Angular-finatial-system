...
@Component({
  selector: 'associates-team-submissions-main',
  templateUrl: './team-submissions-main.component.html',
  styleUrls: ['./team-submissions-main.component.scss']
})
export class AssociatesTeamSubmissionsMainComponent implements OnInit, OnDestroy, AfterViewInit {
  private providersSub: Subscription;
  private restoreSub: Subscription;
  private deleteSub: Subscription;
  private page_permission = 'associate_teams_view';
  ...
  getSubmissions() {
    ...
    this.submissions = [];
    this.dataRaw = [];
    this.assSubmissionsService.getTeamSubmissions().subscribe(res => {
      let data = res.data;
      this.dataRaw = data;
  ...
  restoreSubmission(uuid) {
    this.restoreSub = this.apiService.post('associates/submissions/' + uuid + '/restore').subscribe((res) => {
  ...
  deleteSubmission(uuid) {
    this.deleteSub = this.apiService.delete('associates/submissions/' + uuid).subscribe((res) => {
