...
@Component({
  selector: 'associates-submission-cases',
  templateUrl: './submission-cases.component.html',
  styleUrls: ['./submission-cases.component.scss'],
})
export class AssociatesSubmissionCasesComponent implements OnInit, OnDestroy {
  ...
  editCase(case_object) {
    this._bottomSheet.open(AssociatesSubmissionDraftComponent, {
      disableClose: true,
